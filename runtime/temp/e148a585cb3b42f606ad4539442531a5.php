<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"D:\phpStudy\WWW\filmreviews\public/../application/admin/view/dianying/index.html";i:1533378594;s:69:"D:\phpStudy\WWW\filmreviews\application\admin\view\template\base.html";i:1532754875;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="x-body">
    ...
    <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="admin_add('添加用户','<?php echo url('add'); ?>','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
     ...
     <table class="layui-table">
            ...
            <td><?php echo $vo['dyid']; ?></td>
            <td><?php echo $vo['dytips']; ?></td>
            <td><?php echo $vo['dydis']; ?></td>
            <td><?php echo $vo['dypf']; ?></td>
            <td><img src="<?php echo $vo['dyimg']; ?>" style="width: 100px;height: 150px;"></td>
