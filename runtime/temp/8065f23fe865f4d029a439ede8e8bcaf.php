<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\WWW\filmreviews\public/../application/admin\view\dianying\edit.html";i:1533376706;}*/ ?>
 <link rel="stylesheet" href="/filmreviews/public/static/css/x-admin.css" media="all">
   ...
   <div class="x-body">
        ...
        <div class="layui-form-item">
             <label for="username" class="layui-form-label">导演：</label>
            <div class="layui-input-inline"">
                      <?php if($add == 'add'): ?>
                     
                        <select name="did" lay-verify="required" id="zcySelect">
                           <option value="0">请选择</option> 
                          <?php if(is_array($dy) || $dy instanceof \think\Collection || $dy instanceof \think\Paginator): $i = 0; $__LIST__ = $dy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i;?>
                             <option value="<?php echo $vos['did']; ?>"><?php echo $vos['dyyyxm']; ?></option>
                          <?php endforeach; endif; else: echo "" ;endif; ?>   
                        </select>
                     ...
                     <?php endif; if($add == ''): ?> 
                          <select name="did" lay-verify="required" id="zcySelect">
                              ...
                              <option value="<?php echo $vos['did']; ?>" <?php if($vos['did'] == $vo['did']): ?> selected <?php endif; ?>><?php echo $vos['dyyyxm']; ?></option>
                              <?php endforeach; endif; else: echo "" ;endif; ?>   
                           </select>
                        <?php endif; ?>
