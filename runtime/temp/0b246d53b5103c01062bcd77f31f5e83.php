<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpStudy\WWW\filmreviews\public/../application/admin/view/dianyingdetail/index.html";i:1533378791;s:69:"D:\phpStudy\WWW\filmreviews\application\admin\view\template\base.html";i:1532754875;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<div class="x-body">
    ...
    <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="admin_add('添加用户','<?php echo url('add'); ?>','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px">共有数据：88 条</span></xblock>
     ...
     <table class="layui-table">
            ...
            <td><?php echo $vo['deid']; ?></td>
            <td><?php echo $vo['desc']; ?></td>
            <td><?php echo $vo['dpingfen']; ?></td>
            <td><?php echo $vo['dyear']; ?></td>

            <td>
              <?php if(is_array($dy) || $dy instanceof \think\Collection || $dy instanceof \think\Paginator): $i = 0; $__LIST__ = $dy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vso): $mod = ($i % 2 );++$i;if($vso['did'] == $vo['dperson']): ?><?php echo $vso['dyyyxm']; endif; endforeach; endif; else: echo "" ;endif; ?>
            </td>
...
<script type="text/javascript">
            ...
            function admin_del(obj,id){
                layer.confirm('确认要删除吗？',function(index){
                     //发异步删除数据
                    var request='http://localhost<?php echo \think\Request::instance()->root(); ?>';
