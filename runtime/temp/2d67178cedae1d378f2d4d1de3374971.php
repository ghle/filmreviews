<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\WWW\filmreviews\public/../application/admin/view/dianyingdetail/edit.html";i:1533378432;}*/ ?>
            ...
            <div class="layui-input-inline"">
                     ...
                     <?php endif; if($add == ''): ?> 
                          <select name="dperson" lay-verify="required" id="zcySelect">
                              ...
                              <option value="<?php echo $vos['did']; ?>" <?php if($vos['did'] == $vo['dperson']): ?> selected <?php endif; ?>><?php echo $vos['dyyyxm']; ?></option>
                              <?php endforeach; endif; else: echo "" ;endif; ?>   
                           </select>
                        <?php endif; ?>
